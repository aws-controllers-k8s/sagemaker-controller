...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["endpointConfigName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: endpointConfigName"))
	}
	r.ko.Spec.EndpointConfigName = &tmp
