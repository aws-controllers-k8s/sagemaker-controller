...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=inferencecomponents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=inferencecomponents/status,verbs=get;update;patch
