...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/InferenceComponent"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("inferencecomponents")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.InferenceComponent{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.InferenceComponent),
	}
}
