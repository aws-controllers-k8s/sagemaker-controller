...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.InferenceComponentName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["inferenceComponentName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: inferenceComponentName"))
	}
	r.ko.Spec.InferenceComponentName = &tmp
