...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["notebookInstanceName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: notebookInstanceName"))
	}
	r.ko.Spec.NotebookInstanceName = &tmp
