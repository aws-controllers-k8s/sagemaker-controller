...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/FeatureGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("featuregroups")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.FeatureGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.FeatureGroup),
	}
}
