...
func (rm *resourceManager) incompleteLateInitialization(
	...
	if ko.Spec.TrainingJobDefinition != nil {
		if ko.Spec.TrainingJobDefinition.AlgorithmSpecification != nil {
			if ko.Spec.TrainingJobDefinition.AlgorithmSpecification.MetricDefinitions == nil {
				return true
			}
		}
	}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.TrainingJobDefinition != nil && latestKo.Spec.TrainingJobDefinition != nil {
		if observedKo.Spec.TrainingJobDefinition.AlgorithmSpecification != nil && latestKo.Spec.TrainingJobDefinition.AlgorithmSpecification != nil {
