...
func (rm *resourceManager) sdkCreate(
	...
	rm.metrics.RecordAPICall("CREATE", "CreateHyperParameterTuningJob", respErr)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	_, respErr := rm.sdkapi.StopHyperParameterTuningJobWithContext(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "StopHyperParameterTuningJob", respErr)
	return respErr
}
