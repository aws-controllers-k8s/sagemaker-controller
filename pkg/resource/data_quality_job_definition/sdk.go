...
func (rm *resourceManager) sdkCreate(
	...
	resp, respErr := rm.sdkapi.CreateDataQualityJobDefinitionWithContext(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "CreateDataQualityJobDefinition", respErr)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	_, respErr := rm.sdkapi.DeleteDataQualityJobDefinitionWithContext(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeleteDataQualityJobDefinition", respErr)
	return respErr
}
