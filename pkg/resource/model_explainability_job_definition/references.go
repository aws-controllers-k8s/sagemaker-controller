...
// identifier field.
func validateReferenceFields(ko *svcapitypes.ModelExplainabilityJobDefinition) error {
	return nil
}

// hasNonNilReferences returns true if resource contains a reference to another
// resource
func hasNonNilReferences(ko *svcapitypes.ModelExplainabilityJobDefinition) bool {
	return false
}
