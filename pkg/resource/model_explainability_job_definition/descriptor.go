...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/ModelExplainabilityJobDefinition"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("modelexplainabilityjobdefinitions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ModelExplainabilityJobDefinition{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ModelExplainabilityJobDefinition),
	}
}
