...
var lateInitializeFieldNames = []string{"ResourceSpec"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.ResourceSpec != nil && latestKo.Spec.ResourceSpec == nil {
		latestKo.Spec.ResourceSpec = observedKo.Spec.ResourceSpec
	}
