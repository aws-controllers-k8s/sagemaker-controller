...
var (
	modifyingStatuses = []string{string(svcsdktypes.ModelPackageStatusInProgress),
		string(svcsdktypes.ModelPackageStatusPending),
		string(svcsdktypes.ModelPackageStatusDeleting)}
