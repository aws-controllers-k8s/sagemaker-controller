...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/ModelQualityJobDefinition"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("modelqualityjobdefinitions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ModelQualityJobDefinition{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ModelQualityJobDefinition),
	}
}
