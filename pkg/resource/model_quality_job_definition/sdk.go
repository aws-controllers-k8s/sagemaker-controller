...
func (rm *resourceManager) sdkFind(
	...
	resp, respErr := rm.sdkapi.DescribeModelQualityJobDefinitionWithContext(ctx, input)
	rm.metrics.RecordAPICall("READ_ONE", "DescribeModelQualityJobDefinition", respErr)
	if respErr != nil {
...
func (rm *resourceManager) sdkCreate(
	...
	resp, respErr := rm.sdkapi.CreateModelQualityJobDefinitionWithContext(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "CreateModelQualityJobDefinition", respErr)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	_, respErr := rm.sdkapi.DeleteModelQualityJobDefinitionWithContext(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeleteModelQualityJobDefinition", respErr)
	return respErr
}
