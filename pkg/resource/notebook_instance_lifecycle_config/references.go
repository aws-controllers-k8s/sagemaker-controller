...
// identifier field.
func validateReferenceFields(ko *svcapitypes.NotebookInstanceLifecycleConfig) error {
	return nil
}

// hasNonNilReferences returns true if resource contains a reference to another
// resource
func hasNonNilReferences(ko *svcapitypes.NotebookInstanceLifecycleConfig) bool {
	return false
}
