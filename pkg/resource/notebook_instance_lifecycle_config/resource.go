...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.NotebookInstanceLifecycleConfigName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["notebookInstanceLifecycleConfigName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: notebookInstanceLifecycleConfigName"))
	}
	r.ko.Spec.NotebookInstanceLifecycleConfigName = &tmp
