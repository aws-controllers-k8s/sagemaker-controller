...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=pipelineexecutions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=pipelineexecutions/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"PipelineVersionID"}
...
func (rm *resourceManager) incompleteLateInitialization(
	...
	if ko.Spec.PipelineVersionID == nil {
		return true
	}
	return false
}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.PipelineVersionID != nil && latestKo.Spec.PipelineVersionID == nil {
		latestKo.Spec.PipelineVersionID = observedKo.Spec.PipelineVersionID
	}
