...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/PipelineExecution"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("pipelineexecutions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PipelineExecution{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PipelineExecution),
	}
}
