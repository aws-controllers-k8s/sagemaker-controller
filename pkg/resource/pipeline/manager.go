...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=pipelines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=pipelines/status,verbs=get;update;patch
