...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.PipelineName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["pipelineName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: pipelineName"))
	}
	r.ko.Spec.PipelineName = &tmp
