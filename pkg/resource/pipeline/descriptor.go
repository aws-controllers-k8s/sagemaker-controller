...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/Pipeline"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("pipelines")
