...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=projects/status,verbs=get;update;patch
