...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.ProjectName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["projectName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: projectName"))
	}
	r.ko.Spec.ProjectName = &f0
