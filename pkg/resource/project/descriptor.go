...
const (
	FinalizerString = "finalizers.sagemaker.services.k8s.aws/Project"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("projects")
