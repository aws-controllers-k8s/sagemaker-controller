...
const (
	FinalizerString = "finalizers.sagemaker.services.k8s.aws/Space"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("spaces")
