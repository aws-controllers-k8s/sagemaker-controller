...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=spaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=spaces/status,verbs=get;update;patch
