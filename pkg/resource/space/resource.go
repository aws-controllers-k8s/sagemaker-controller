...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.SpaceName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f1, ok := fields["spaceName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: spaceName"))
	}
	r.ko.Spec.SpaceName = &f1
