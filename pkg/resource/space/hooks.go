...
var (
	modifyingStatuses = []string{
		string(svcsdktypes.SpaceStatusPending),
		string(svcsdktypes.SpaceStatusUpdating),
		string(svcsdktypes.SpaceStatusDeleting),
	}
...
func (rm *resourceManager) customDescribeSpaceSetOutput(ko *svcapitypes.Space) {
