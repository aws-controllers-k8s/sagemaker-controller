...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.LabelingJobName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["labelingJobName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: labelingJobName"))
	}
	r.ko.Spec.LabelingJobName = &tmp
