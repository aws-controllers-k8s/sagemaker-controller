...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/ModelBiasJobDefinition"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("modelbiasjobdefinitions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ModelBiasJobDefinition{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ModelBiasJobDefinition),
	}
}
