...
INFERENCE_COMPONENT_RESOURCE_PLURAL = "inferencecomponents"
...
INFERENCE_COMPONENT_STATUS_INSERVICE = "InService"
INFERENCE_COMPONENT_STATUS_CREATING = "Creating"
INFERENCE_COMPONENT_STATUS_UPDATING = "Updating"

DELETE_WAIT_PERIOD = 4
DELETE_WAIT_LENGTH = 30

JOB_DELETE_WAIT_PERIODS = 30
JOB_DELETE_WAIT_LENGTH = 30

INFERENCE_COMPONENT_DELETE_WAIT_PERIODS = 60
INFERENCE_COMPONENT_DELETE_WAIT_LENGTH = 30
