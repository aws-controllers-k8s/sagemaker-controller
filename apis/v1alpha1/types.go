...
type AIBenchmarkEndpoint struct {
	TargetContainerHostname *string `json:"targetContainerHostname,omitempty"`
}
...
// An Amazon S3 data channel for a recommended deployment configuration, containing
// model artifacts or optimized model outputs.
...
// The output configuration for an AI recommendation job, including the S3 location
// for results and the model package group for deployment.
...
type AppDetails struct {
	...
	CreationTime *metav1.Time `json:"creationTime,omitempty"`
	// Types duplicated from IronmanApiServiceModel for federation.These types are
	// defined in other service directories and are notavailable via IronmanApiServiceCommonModel.
...
type InferenceComponentRuntimeConfigSummary struct {
	...
	PlacementStatus  []*InferenceComponentPlacementStatus `json:"placementStatus,omitempty"`
}
...
type MLflowConfiguration struct {
	...
	MlflowResourceARN    *string `json:"mlflowResourceARN,omitempty"`
}
...
type MetricsConfig struct {
	EnableEnhancedMetrics           *bool  `json:"enableEnhancedMetrics,omitempty"`
	MetricPublishFrequencyInSeconds *int64 `json:"metricPublishFrequencyInSeconds,omitempty"`
}
...
type MlflowDetails struct {
	...
	MlflowRunID        *string `json:"mlflowRunID,omitempty"`
}
...
type ModelPackageConfig struct {
	...
	SourceModelPackageARN *string `json:"sourceModelPackageARN,omitempty"`
}
...
type ReservedCapacityOffering struct {
	EndTime            *metav1.Time `json:"endTime,omitempty"`
	ExtensionEndTime   *metav1.Time `json:"extensionEndTime,omitempty"`
	ExtensionStartTime *metav1.Time `json:"extensionStartTime,omitempty"`
	StartTime          *metav1.Time `json:"startTime,omitempty"`
}
...
type TrainingPlanExtension struct {
	...
	ExtendedAt       *metav1.Time `json:"extendedAt,omitempty"`
...
// offering ID with the ExtendTrainingPlan (https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_ExtendTrainingPlan.html)
...
type TrainingProgressInfo struct {
	...
	TotalStepCountPerEpoch *int64 `json:"totalStepCountPerEpoch,omitempty"`
}
